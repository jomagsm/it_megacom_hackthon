       ...
       Container(
         ...
         decoration: BoxDecoration(
           ...
           image: DecorationImage(
             image: NetworkImage(
                 buyingProduct[index].product.avatar),
             fit: BoxFit.cover,
           ),
         ),
       ),
        SizedBox(
                             ...
                             Container(
                                 width:87,
                                 child: Text(
                                 buyingProduct[index].product.name,style: AtextThemes.titleTextField)
                             ),
        IconButton(
        ...
        Container(
                               ...
                               width: 20,
                               child: Center(
                                 child: Text((  buyingProduct[index].product.price.toInt()).toString(),
                                     style: AtextThemes.titleTextField),
                               ),
                             ),
         Text('с',
             style: GoogleFonts.lato(
                 textStyle: TextStyle(
                     ...
                     color: AcolorPalette.textforgot,decoration: TextDecoration.underline))),
                           ],
                         ),
     );
    },
